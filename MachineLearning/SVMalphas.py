...
with col1:
    ...
    alphas[2] = st.slider(label=":orange[$\\alpha_2$]: Choose a value between 0 and 3.", min_value=0.0, max_value=3.0, value=0.5, step=0.01)
    ...
    alphas[11] = st.slider(label=":blue[$\\alpha_{11}$]: Choose a value between 0 and 3.", min_value=0.0, max_value=3.0, value=0.34, step=0.01)
    
    #st.write("$\\alpha_{13}$")

    alphas[13] = st.slider(label=":blue[$\\alpha_{13}$]: Choose a value between 0 and 3.", min_value=0.0, max_value=3.0, value=0.33, step=0.01)
